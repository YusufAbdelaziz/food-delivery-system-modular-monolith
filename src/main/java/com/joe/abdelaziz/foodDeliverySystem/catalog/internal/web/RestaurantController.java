...
import com.joe.abdelaziz.foodDeliverySystem.common.customResponses.UpdateResponse;
...
public class RestaurantController {
    ...
    public ResponseEntity<RestaurantDTO> getRestaurantById(
        ...
        return ResponseEntity.ok().body(restaurantService.findDtoById(id));
    }
    ...
    public ResponseEntity<UpdateResponse> updateRestaurantVisibility(
        ...
        return ResponseEntity.ok()
                .body(
                        new UpdateResponse("Restaurant visibility has been changed successfully", id, visible));
    }
