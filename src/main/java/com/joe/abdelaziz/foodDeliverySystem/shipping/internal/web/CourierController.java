package com.joe.abdelaziz.foodDeliverySystem.shipping.internal.web;
import com.joe.abdelaziz.foodDeliverySystem.shipping.api.dto.*;
...
public class CourierController {
  ...
  public ResponseEntity<CourierDTO> createCourier(
      @Valid @RequestBody @Parameter(description = "Courier details", required = true)
          CourierDTO courier) {
  ...
  public ResponseEntity<CourierDTO> updateCourier(
      @RequestBody @Parameter(description = "Updated courier details", required = true)
          CourierDTO courier) {
  ...
  @Operation(
      ...
      description = "Assigns a courier to an order based on their IDs")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Courier assigned to order successfully",
  ...
  public ResponseEntity<OrderDTO> assignCourierToOrder(
      @RequestBody @Parameter(description = "Order and Courier IDs", required = true)
          JsonNode node) {
  ...
  @Operation(
      ...
      description = "Fetches all orders assigned to a courier by their ID")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
