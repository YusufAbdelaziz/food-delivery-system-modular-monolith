...
public class JwtService {
        ...
        new Function<Claims, String>() {
          ...
          public String apply(Claims claim) {
            ...
            List<LinkedHashMap<String, String>> authorities =
                (List<LinkedHashMap<String, String>>) claim.get("authorities");
            ...
            return authorities.getLast().get("authority").substring(rolePrefix.length())
                + ":"
                + claim.getSubject();
          }
        });
  ...
  private String buildToken(
      Map<String, Object> extraClaims, UserDetails userDetail, Long duration) {
    return Jwts.builder()
        .claims(extraClaims)
